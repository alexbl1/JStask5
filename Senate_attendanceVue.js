...
var app = new Vue({
  el: '#app',
  data: {
      titleGlance: "Senate at a glance",
      titleLeast: "Least Engage (Bottom 10% Attend.)",
      titleMost: "Most Engage (Top 10% Attend.)",
      theadsG: ["Party", "Number of Representants", "% Vote with Party"],
      theadsE: ["Name", "N. Missed Votes", "% Missed"],
      members:[],
      statisticsVue:{},
      bottomTen:[],
      topTen:[]
...
var statistics = {
    ...
    republicans: {total:0, avg:0,},
    democrats: {total:0, avg:0,},
    independents: {total:0, avg:0,},
    total_members: {total:0, avg:0,} 
}
